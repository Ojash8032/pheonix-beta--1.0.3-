        ...
        while True:
            ...
            if refquery:
                if any(word in refquery for word in
                    ...
                    refquery = refquery.replace("please", "")
                    refquery = refquery.replace("phoenix", "")
                    refquery = refquery.replace("for me", "")
                    refquery = refquery.replace("would you", "")
                    refquery = refquery.replace("pheonix", "")
                    refquery = refquery.replace("open", "")
